...
public class AcceleratingBackwards_test {

	@Test
	public void pressRightPedalOnce_test() {
		Context context = new Context();
		AcceleratingBackwards startState = new AcceleratingBackwards();
		...
		assertTrue(startState.pressRightPedalOnce(context).toString().equals("Accelerating backwards"));
	...
	public void pressRightPedalTwice_test() {
		...
		assertTrue(startState.pressRightPedalTwice(context).toString().equals("Accelerating backwards"));
	...
	public void holdRightPedalOverFiveSec_test() {
		...
		assertTrue(startState.holdRightPedalOverFiveSec(context).toString().equals("Accelerating backwards"));
	...
	public void toString_test() {
		...
		assertSame("Accelerating backwards", startState.toString());
		assertEquals("accelerating backwards", startState.toString().toLowerCase());
		assertTrue(startState.toString().equals("Accelerating backwards"));
	}
